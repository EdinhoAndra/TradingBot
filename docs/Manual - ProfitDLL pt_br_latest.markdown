...
servidores e criar os serviços necessários para comunicação. Outras funções podem retornar o status de erro
...
FlagFlag ValorValor SignificadoSignificado
...
tcsOpened // Ativo em negociação aberta
tcsFrozen
tcsInhibited
